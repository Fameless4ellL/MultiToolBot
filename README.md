...
1. [Developing a skeleton](#Developing a skeleton)
1. [Chapter 1 Chatbot conversation using a finite state machine](#Chapter 1 Chatbot conversation using a finite state machine)
    1. [1.1 Finite state machine](#1.1 Finite state machine)
    1. [1.2 Math model](#1.2 Math model)
    1. [1.3 Theory](#1.3 Theory)
    1. [1.4 Implementation](#1.4 Implementation)
1. [Chapter 2 The difference between Multithreading and Asyncio in Bot development](#Chapter 2 The difference between Multithreading and Asyncio in Bot development)
    1. [2.1 Asynchronous](#2.1 Asynchronous)
    1. [2.2 Multithreading](#2.2 Multithreading)
    1. [2.3 Async vs thread](#2.3 Async vs thread)
    1. [2.4 Conclusion](#2.4 Conclusion)
1. [Chapter 3 Scanning documents by using OpenCV’s CNN method](#Chapter 3 Scanning documents by using OpenCV’s CNN method)
    1. [3.1 OpenCV](#3.1 OpenCV)
    1. [3.2 CNN Network Architecture](#3.2 CNN Network Architecture)
        1. [3.2.1 Convolutional layer](#3.2.1 Convolutional layer)
        1. [3.2.2 Pooling](#3.2.2 Pooling)
        1. [3.2.3 Fully connected neural network](#3.2.3 Fully connected neural network)
        1. [3.2.4 Training](#3.2.4 Training)
    1. [3.3 Scanning documents algorithm](#3.3 Scanning documents algorithm)
    1. [3.4 Implementation](#3.4 Implementation)
1. [Chapter 4 Pomodoro timer](#Chapter 4 Pomodoro timer)
    1. [4.1 Context](#4.1 Context)
    1. [4.2 Goals of the Pomodoro timer](#4.2 Goals of the Pomodoro timer)
    1. [4.3 Assumptions Fundamentals of the Pomodoro technique](#4.3 Assumptions Fundamentals of the Pomodoro technique)
    1. [4.4 Pomodoro timer’s algorithm](#4.4 Pomodoro timer’s algorithm)
    1. [4.5 Implementation](#4.5 Implementation)
1. [Chapter 5 Reminder](#Chapter 5 Reminder)
    1. [5.1 Context](#5.1 Context)
    1. [5.2 Reminder’s algorithm](#5.2 Reminder’s algorithm)
        1. [5.2.1 SimpleCalendar](#5.2.1 SimpleCalendar)
        1. [5.2.2 Timepicker](#5.2.2 Timepicker)
